...
In this example we will make the code necessary for a Particle Filter
...
Additionally you need to have an understanding of how anonymous functions, or lambda expressions work for the [RunCommand](../api/runCommand.md)
implementation.
